...
const hardRejection = (log = console.error) => {
	...
	process.on('unhandledRejection', error => {
		if (!(error instanceof Error)) {
			error = new Error(`Promise rejected with value: ${util$3.inspect(error)}`);
		}
		log(error.stack);
		process.exit(1);
	});
...
const fallback = getDefaultExportFromCjs(lib$3);
var lib$2 = {};
var lib$1 = {};
var jsTokens = {};
...
export { readPackageUpSync as a, constructParserOptions as b, camelcaseKeys as c, decamelizeKeys as d, decamelize as e, hardRejection$1 as h, normalizePackageData as n, redent as r, trimNewlines as t, yargsParser as y };
